...
- [Skills](https://github.com/kevinutecht/pi-skill-accountability-partner) — Codex integration
...
- **Agent integration** — spawning Codex skills from a TUI for AI-powered review
